...
Text only, pretty brutalist and straight to the point.
For professional tools, brutalism is generally a good thing.
You need to remove everything that is not necessary.
But also you want to support complexity of a professional tool.
