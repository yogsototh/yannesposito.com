...
#+html_head_extra: <style>:root { --bg: #ff0; --fg: #000; } img,svg {filter: contrast(0.5)sepia(100%)hue-rotate(20deg)saturate(15); } svg:hover {filter:none;} body { font-family: Helvetica, sans-serif; } h1 { font-size: 4em; } </style>
