...
#+lightbk: #0f0
#+darkbk: #080
#+html_head_extra: <style>img,svg {filter: brightness(0.8) sepia(100%) hue-rotate(80deg) saturate(5); } body,h1,h2,h3,nav,.meta { font-family: "Comic Sans MS", Chalkboard, sans-serif; color: #080; } body{border-top: solid 5px var(--g);border-bottom: solid 5px var(--g);} :root { --b: #080; } </style>
