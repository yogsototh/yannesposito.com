...
This article will simply provide an example how I could create an emacs package
(not yet distributed) to use Metapost in my org-mode documents.
...
One of the main issue with Metapost is that, like $L^AT_EX$, it generates a bunch
of temporary files and clutter your current directory with them.
...
This is why I wrote a very simple ~mp2png~ script.
It is inspired by ~mp2png.sh~ I could find in [[https://github.com/foretspaisibles/bsdowl][bsdowl]].
