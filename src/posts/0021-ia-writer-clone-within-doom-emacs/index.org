...
So the effect I am looking to achieve can be seen in this gif.
...
face to the current sentence, but does not affect the other text in the buffer.
In fact to make it work, you need to make the default color grey, and only
set black for the highlighted text.

But nice, I have recently created a personal theme close to that.
I created a new one.
